...
<div class="app-content-header" style="padding: 6px 0.5rem;">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h1 class="mb-0 fs-3">Category List</h1>
            </div>
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <script>
                const table = new Tabulator("#category_table", {
                    ajaxURL: "qur_category_master.php?action=list",
                    ajaxConfig: "GET",
                    layout: "fitColumns",
                    pagination: true,
                    paginationSize: 10,
                ...
                document.addEventListener("click", function(e) {
                    ...
                    if (deleteBtn) {
                        ...
                        if (confirm("Delete this category?")) {
                            fetch("qur_category_master.php?action=delete", {
                                    method: "POST",
                                    headers: {
                ...
                document.addEventListener("click", function(e) {
                    ...
                    if (editBtn) {
                        ...
                        fetch("qur_category_master.php?action=get&id=" + encodeURIComponent(id))
...
document.getElementById("categoryForm").addEventListener("submit", function(e) {
    ...
    fetch("qur_category_master.php?action=save", {
            method: "POST",
            body: formData
        })
...
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h1 class="mb-0 fs-3">Category Recycle Bin</h1>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                <script>
                const table = new Tabulator("#category_table", {
                    ajaxURL: "qur_category_master.php?action=list1",
                    ajaxConfig: "GET",
                    layout: "fitColumns",
                    pagination: true,
                    paginationSize: 10,
                ...
                document.addEventListener("click", function(e) {
                    ...
                    if (confirm("Restore this category?")) {
                        fetch("qur_category_master.php?action=restore", {
                                method: "POST",
                                headers: {
                                    "Content-Type": "application/x-www-form-urlencoded"
                                },
