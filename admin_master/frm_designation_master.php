...
<div class="app-content-header" style="padding: 6px 0.5rem;">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h1 class="mb-0 fs-3">Designation List</h1>
            </div>
            <div class="col-sm-6">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb float-sm-end">
                        <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#designationModal">
...
<div class="app-content">
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                <div id="designation_table"></div>

                <script>
                const table = new Tabulator("#designation_table", {
                    ajaxURL: "qur_designation_master.php?action=list",
                    ajaxConfig: "GET",
                    layout: "fitColumns",
                    pagination: true,
                    paginationSize: 10,
                ...
                document.addEventListener("click", function(e) {
                    ...
                    if (deleteBtn) {
                        ...
                        if (confirm("Delete this designation?")) {
                            fetch("qur_designation_master.php?action=delete", {
                                    method: "POST",
                                    headers: {
                ...
                document.addEventListener("click", function(e) {
                    ...
                    if (editBtn) {
                        ...
                        fetch("qur_designation_master.php?action=get&id=" + encodeURIComponent(id))
                            .then(response => response.json())
                            .then(data => {
                                document.getElementById("designation_id").value = data.id;
                                document.getElementById("designation").value = data.designation;
                                document.getElementById("designationModalLabel").innerHTML =
                                    "Edit Designation";
                ...
                document.querySelector('[data-bs-target="#designationModal"]').addEventListener("click", function() {
                    document.getElementById("designationForm").reset();
                    document.getElementById("designation_id").value = "";
                    document.getElementById("designationModalLabel").innerHTML = "Add Designation";
...
document.getElementById("designationForm").addEventListener("submit", function(e) {
    ...
    fetch("qur_designation_master.php?action=save", {
            method: "POST",
            body: formData
        })
...
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h1 class="mb-0 fs-3">Designation Recycle Bin</h1>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <script>
                const table = new Tabulator("#designation_table", {
                    ajaxURL: "qur_designation_master.php?action=list1",
                    ajaxConfig: "GET",
                    layout: "fitColumns",
                    pagination: true,
                    paginationSize: 10,
                ...
                document.addEventListener("click", function(e) {
                    ...
                    if (confirm("Restore this designation?")) {
                        fetch("qur_designation_master.php?action=restore", {
                                method: "POST",
                                headers: {
                                    "Content-Type": "application/x-www-form-urlencoded"
                                },
                            ...
                            .then(res => {
                                if (res.status === "success") {
                                    table.replaceData();
                                    alert("Designation restored successfully.");
                                } else {
